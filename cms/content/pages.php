...
$fields = array('id', 'navigator', 'position', 'page');//'status', 
$value = array();
$type = array();
...
//$attributes['page'] = array('required' => 'required');
...
$type['page'] = 'textarea'; $tinymce['page']=true;  $labelFullRow['page']=true; $height['page'] = '500px;'; $width['page'] = '100%;'; 
...
*/
$cols = $items =array();
$cols = array('Pages' => '8', 'Position' => '4');//Column title and width
$items['Pages'] = array('navigator');
